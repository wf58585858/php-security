	...
	<div class="content-wrapper">
		...
		<div id="content-container">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li>
						<a href="dashboard.php"><i class="fa fa-home"></i> Admin Panel</a>
					</li>
...
';
							...
							<div class="box-body">
								<div class="row">
									<div class="col-md-4">
										<div class="well">
											<center>
												<h4>Detection Method #1</h4>
												<br /> Connects with Proxy API and verify if the visitor is using a Proxy
												<br /><br /><br />
									...
									<div class="col-md-4">
										<div class="well">
											<center>
												<h4>Detection Method #2</h4>
												<br /> Check the visitor's HTTP Headers for Proxy Elements
												<br /><br /><br />
												<div class="switch switch-sm switch-success">
									...
									<div class="col-md-4">
										<div class="well">
											<center>
												<h4>Detection Method #3</h4>
												<br /> Scans the visitor's ports to detect if it is behind a Proxy or not. This Proxy Detection Method is used mainly to detect and block online proxy websites.<br />
												<strong>(False-Positives are possible)</strong> <br /><br /><br />
												<div class="switch switch-sm switch-success">
									...
									<center>
										<button class="btn btn-flat btn-lg btn-block btn-primary mar-top" name="save2" type="submit">
				...
				<div class="col-md-4">
					<div class="box">
						...
						<div class="box-body">
							<strong>Proxy</strong> or
							<strong>Proxy Server</strong> is basically another computer which serves as a hub through which internet requests are processed. By connecting through one of these servers, your computer sends your requests to the proxy server which then processes your request and returns what you were wanting.
						</div>
					</div>
					<div class="box">
						<div class="box-header">
						...
						<div class="panel-footer">
							<button class="btn btn-flat btn-block btn-primary mar-top" name="save" type="submit">
								<i class="fa fa-floppy-o"></i> Save
							</button>
						</div>
						</form>
