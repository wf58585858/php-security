				...
				<?php
					...
					function alexaRank($site)
					{
						...
						if($a != null)
						{
							...
							if($alexa_rank == null) $alexa_rank = 'No Rank';
						}
						else
						{
							$alexa_rank = 'No Rank';
					...
					if(checkOnline($site))
					{
						...
						if($title == '') $title = '<h4><span class="label label-default">No Title</span></h4>';
						if(@$description == '') $description = '<h4><span class="label label-default">No Description</span></h4>';
						if(@$keywords == '') $keywords = '<h4><span class="label label-default">No Keywords</span></h4>';
						if(@$author == '') $author = '<h4><span class="label label-default">No Author</span></h4>';
					}
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr>
											<td>Zend Version</td>
											<td>
												<h4><span class="label label-danger"><?php
															echo $zend_version;
														?></span>
												</h4>
											</td>
